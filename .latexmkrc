...
$force_mode = 1;
$recorder = 1;
$sleep_time = 1; #The time to sleep (in seconds; default:2) between checking for source file changes
#$preview_continuous_mode = 1; #Equivalent to the -pvc option; It's better use latexmk -pvc $* directly
